---
layout: post
title: New motor test - bigger, more torque
...
At first mounted the motors low so the scissors were the correct level. However the robot kept getting stuck due to the dragging motors.
...
Notes:
* motors are louder, audible across the yard but not too annoying. Might want a casing to protect them and reduce noise.
* wheelbase is shorter, robot noticeably tips forward/backward
* next steps - figure out how to detect end of yard and turn around